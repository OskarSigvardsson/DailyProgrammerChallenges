...
It should be noted that while the rhyming algorithm is very elegant, Ms. Ellis description is not *quite* rigorous. For instance, there's an extra rule that she doesn't mention that only applies when names start with a vowel (such as "Arnold"), and it's not quite clear exactly what you should do when the names start with M, F or B. You will have to fill in the blanks as best you can on your own. 
...
Rhyme your username! Or even, if you feel comfortable sharing it, your real name!

If you don't want to do either of those things, I guess you could always rhyme
